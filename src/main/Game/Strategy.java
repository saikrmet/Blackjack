...
public class Strategy {
    ...
    public static class StatResult {
        ...
        public StatResult(Decision decision, Float expectedPayout) {
    ...
    private final String stratType;
    ...
    public Strategy(List<Player> players, String stratType, StrategyParser strategyParser, Deck deck) {
...
//                System.out.println(decision);
    ...
    private Decision makeDecision(Hand hand) throws Exception {
        if (Objects.equals(this.stratType, "Naive")) {
            return this.makeDecisionHW1(hand);
        } else if (Objects.equals(this.stratType, "Wiki")) {
    ...
    private Decision makeDecisionDealer(Hand hand) throws Exception {
        //System.out.println("DEALER HAND IS: " + hand);
